...
class Mode:
    ...
    def theme_changed(page:Page , Button :IconButton):
        ...
        with open(r"D:\Python\Flet - Cross Platform\1.CALCULATOR\switch_state.json", "w+") as f:
            json.dump(state, f)
    ...
    def load(page:Page , Button :IconButton):
        Mode.is_dark_mode
        with open(r"D:\Python\Flet - Cross Platform\1.CALCULATOR\switch_state.json","r") as f:
            state = json.load(f)
